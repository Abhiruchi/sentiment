...
For example:
  ...
  Hutto, C.J. & Gilbert, E.E. (2014).: A Parsimonious Rule-based Model for 
...
sys.path.append('C:\Users\hp\Desktop\project\PERFECT ------------------------------------------------vaderSentiment-master\vaderSentiment')
reload(sys)
...
if __name__ == '__main__':
    ...
    tricky_sentences = [
                        ...
                        "Bought a new iphone today and it rules over me it is perfect",
						"Mishra is my boyfriend. I hate him",
						"Sometimes life takes you to some places you never wanted to go",
						"facebook wastes all of my time.",
